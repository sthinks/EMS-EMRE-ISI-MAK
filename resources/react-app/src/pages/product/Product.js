...
function Product() {
    ...
    useEffect(() => {
        const closeDropdown = (e) => {
            if (
                e.target.className === "absolute w-full h-full bg-white py-12"
            ) {
                setModal(false);
            }
        };
    ...
    return !loading ? (
        ...
        <>
            ...
            <div className="relative w-full h-auto">
                <div className="container mx-auto flex justify-center items-center  relative w-full top-[-130px] max-lg:top-[-80px] max-md:top-0 max-md:my-10 max-xl:relative">
                    <div className="w-full grid grid-cols-4 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-5">
                        {data?.map((item, i) => (
                            <div
                                className="cursor-pointer mt-3 h-auto bg-white flex justify-start items-center flex-col shadow-ems relative hover:-translate-y-2 transition duration-300 ease-out max-md:hover:scale-100 "
                                onClick={() =>
                            ...
                            >
                                ...
                                />
                                <div className="px-5 pt-10 pb-14 w-full">
