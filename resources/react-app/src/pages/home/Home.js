    ...
    return loading ? (
        ...
        <div>
            ...
            <div className="relative w-full h-auto">
                <div className="flex justify-center items-center px-36 relative w-full top-[-130px] max-lg:top-[-80px] max-md:top-0 max-md:my-10 max-xl:px-14 max-md:px-2 max-xl:relative">
                    <div className="w-full grid grid-cols-4 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-2">
                        {product?.map((item, i) => (
                            <div
                                key={i}
                                className="relative cursor-pointer h-auto bg-white flex justify-start items-center flex-col shadow-ems hover:-translate-y-2 transition duration-300 ease-out max-md:hover:scale-100"
                                onClick={() =>
                                    navigate(`/ürünler/${item.slug}`)
                                }
                    ...
                    <div className="z-50 grid grid-cols-3 px-48 py-28 gap-28 max-xl:py-24 max-xl:px-14 max-md:py-4 max-md:gap-14 max-sm:grid-cols-1">
                        <div>
                            ...
                            <p className=" text-sm font-normal my-10">
                                Firmamız EMS EMRE ISI MAKİNALARI İMALAT SAN.
                                TİC. LTD. ŞTİ. olarak 1991 senesinden beri
                                ENDÜSTRİYEL FIRIN İMALATI alanında faaliyet
                                göstermektedir.
                            </p>
                            <a
            ...
            <div className="w-full flex justify-center items-center flex-col mb-20">
                ...
                <p className="my-5">
                    Türkiye ve Dünya pazarındaki iş ortaklarımız
                </p>
