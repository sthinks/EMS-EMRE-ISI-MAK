                ...
                <div className="w-full px-48 max-xl:px-24 max-md:px-10 max-sm:px-2">
                    {data?.map((item, i) => (
                        <div
                            ...
                            key={i}
                        >
                            <div className="relative w-4/6 h-[350px]">
                                <img
                                    className="w-full h-[350px] object-cover max-md:w-full cursor-pointer"
                                ...
                                <HiCursorClick
                                    onClick={() => modalHandler(item.id)}
                                    className="z-50 absolute bottom-7 right-7 -rotate-45 animate-bounce text-4xl text-white cursor-pointer"
                                />
                            </div>
